<script setup>
    ...
    import { appointmentStatusName } from '../../helper.js';
    import { statusColor } from '../../helper.js';
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr v-for="(appointment, index) in appointments.data" :key="appointment.id">
                                        ...
                                        <td>
                                            <span class="badge" :class="`badge-${statusColor(appointment.status)}`">{{ appointmentStatusName(appointment.status) }}</span>
                                        </td>
                                        <td>
                                            ...
                                            <a @click="deleteAppointment(appointment.id)" href="#">
